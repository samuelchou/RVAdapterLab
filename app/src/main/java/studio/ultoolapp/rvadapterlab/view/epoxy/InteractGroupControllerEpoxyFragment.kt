...
class InteractGroupControllerEpoxyFragment : Fragment() {
    private lateinit var binding: FragmentInteractEpoxyBinding

    private val itemLists = mutableListOf<DateAmountItem>()
    private lateinit var epoxyController: InteractGroupController
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        epoxyController = InteractGroupController().apply {
            itemClickListener = object : InteractGroupController.OnItemClickListener {
